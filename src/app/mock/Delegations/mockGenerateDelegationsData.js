...
function generateRandomDelegationData(count) {
    const data = [];
...
exports.generateRandomDelegationData = generateRandomDelegationData;
//# sourceMappingURL=mockGenerateDelegationsData.js.map